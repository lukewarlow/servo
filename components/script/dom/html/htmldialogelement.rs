...
impl HTMLDialogElement {
    ...
    pub fn show_a_modal(&self, source: Option<DomRoot<Element>>, can_gc: CanGc) -> ErrorResult {
        ...
        self.queue_dialog_toggle_event_task(DOMString::from("closed"), DOMString::from("open"), source);
    ...
    pub fn close_the_dialog(&self, result: Option<DOMString>, source: Option<DomRoot<Element>>, can_gc: CanGc) {
        let subject = self.upcast::<Element>();
        ...
        self.queue_dialog_toggle_event_task(DOMString::from("open"), DOMString::from("closed"), source);
    ...
    pub fn queue_dialog_toggle_event_task(&self, old_state: DOMString, new_state: DOMString, source: Option<DomRoot<Element>>) {
        ...
        let trusted_source = source.as_ref().map(|el| {
            Trusted::new(el.upcast::<EventTarget>())
        });
...
impl HTMLDialogElementMethods<crate::DomTypeHolder> for HTMLDialogElement {
    ...
    fn Show(&self, can_gc: CanGc) -> ErrorResult {
        ...
        self.queue_dialog_toggle_event_task(DOMString::from("closed"), DOMString::from("open"), None);
